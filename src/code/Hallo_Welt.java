...
public class Hallo_Welt {
  ...
  public static void main(String args[]) {
    Hallo_Welt agent = new Hallo_Welt();
  ...
  private void run(int timeInSec) {
    ...
    for (int i = 0; i < cycles; i++) {
      ...
      degree = Math.toDegrees(percIn.getJoint(RobotConsts.LeftKneePitch));
      //if(degree <= 90){
      effOut.setJointCommand(RobotConsts.RightKneePitch, -0.9);
      effOut.setJointCommand(RobotConsts.LeftKneePitch, -0.9);
      //}
      effOut.setJointCommand(RobotConsts.LeftFootPitch, 0.3);
      effOut.setJointCommand(RobotConsts.RightFootPitch, 0.3);
      effOut.setJointCommand(RobotConsts.RightHipPitch, 0.80);
      effOut.setJointCommand(RobotConsts.LeftHipPitch, 0.80);
