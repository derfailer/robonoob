 ...
 * is started. 
 */
public class Agent_SimpleSoccer1 {

  public static void main(String args[]) {
    
    Agent_SimpleSoccer1 agent = new Agent_SimpleSoccer1();
  ...
  private SoccerThinking1 soccerThinking1;
  ...
  final String id = "2";
  final String team = "simpleSoccer1";
  ...
  private void init() {
    ...
    soccerThinking1 = new SoccerThinking1(percIn, localView, kfMotion, log);
  ...
  public void run(){
    ...
    for (int i = 0; i < totalServerCycles; i++) {
      ...
      try {
        ...
        java.util.logging.Logger.getLogger(Agent_SimpleSoccer1.class.getName()).log(Level.SEVERE, null, ex);
      }
