 ...
 * is started. 
 */
public class Agent_SimpleSoccerStuermer {

  public static void main(String args[]) {
    
    Agent_SimpleSoccerStuermer agent = new Agent_SimpleSoccerStuermer();
  ...
  private void init() {
    ...
    soccerThinking1 = new SoccerThinkingStuermer(percIn, localView, kfMotion, log);
  ...
  public void run(){
    ...
    for (int i = 0; i < totalServerCycles; i++) {
      ...
      try {
        ...
        java.util.logging.Logger.getLogger(Agent_SimpleSoccerStuermer.class.getName()).log(Level.SEVERE, null, ex);
      }
